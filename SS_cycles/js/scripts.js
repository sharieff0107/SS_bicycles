...
// Add this code to your JavaScript file or within a <script> tag in your HTML file
var cartCount = 0;

function addTocart(productId) {
    cartCount++;
    updatecartCount();
    // You can also make an AJAX request to your backend to store the selected product
}
...
(function () {
    ...
    var init = function () {
        var slider2 = new rSlider({
            target: '#price_range',
            values: ["₹100", "500", "1000", "2000", "5000", "10000", "20000", "25000", "50000", "90000", "₹100000"],
            step: 1,
            range: true,
            set: ["₹100", "₹100000"],
            tooltip: true,
